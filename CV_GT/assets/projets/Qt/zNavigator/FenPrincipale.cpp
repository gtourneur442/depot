...
FenPrincipale::FenPrincipale()
{
    ...
    onglets->addTab(creerOngletPageWeb(tr("http://openclassrooms.com")), tr("(Nouvelle page)"));
    ...
    setWindowIcon(QIcon("images/znavigator.png"));
    setWindowTitle(tr("zNavigator"));
}
...
{
    pageActuelle()->load(QUrl(tr("http://openclassrooms.com")));
}
...
{
    QMessageBox::information(this, tr("A propos..."), tr("zNavigator est un projet réalisé pour illustrer les tutoriels C++ du <a href=\"http://openclassrooms.com\">Site suivant</a>.<br>Les images de ce programme ont été créées par <a href=\"http://www.everaldo.com\">Everaldo Coelho</a>"));
}

void FenPrincipale::nouvelOnglet()
{
    int indexNouvelOnglet = onglets->addTab(creerOngletPageWeb(tr("")), tr("(Nouvelle page)"));
